  ...
  vi: {
    ...
    dashboard: {
      dashboardT: {
        ...
        credits: { warning: "Credits sắp hết", noCreditsTitle: "Hết credits", remaining: "còn lại", hint: "Nạp thêm để tránh gián đoạn khi chạy test.", noCreditsHint: "Bạn không thể bắt đầu test khi hết credits. Vui lòng nạp thêm để tiếp tục.", topUp: "Nạp thêm" },
        history: { ...dashboardEn.history, title: "Lịch sử test", runs: "lượt chạy · đã lưu vào tài khoản", completed: "hoàn tất", failed: "thất bại", success: "thành công", project: "Dự án", started: "Bắt đầu", duration: "Thời gian", status: "Trạng thái", passedFailed: "Passed / Failed", score: "Điểm", creditsUsed: "Credits", report: "Báo cáo", empty: "Chưa có lịch sử test", emptyHint: "Chạy test đầu tiên để xem kết quả tại đây" },
        toasts: { ...dashboardEn.toasts, githubConnected: "Đã kết nối GitHub", githubFailed: "Kết nối GitHub thất bại", selectZip: "Vui lòng chọn file .zip", githubExpired: "GitHub token hết hạn. Vui lòng kết nối lại.", selectZipFirst: "Vui lòng chọn file .zip trước", selectRepo: "Vui lòng chọn repository", pipelineStarted: "Pipeline test đã bắt đầu!", cloningStarted: "pipeline đã bắt đầu!", startFailed: "Không thể bắt đầu test", noCredits: "Bạn đã hết credits. Vui lòng nạp thêm để tiếp tục sử dụng." },
      },
    },
    profile: {
      profileT: {
