...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* ── Chat panel ── */}
      {isOpen && (
        <div className="fixed top-1/2 left-24 z-50 w-[360px] max-h-[560px] translate-y-[calc(-50%+30px)] flex flex-col rounded-2xl shadow-2xl border border-slate-200 bg-white overflow-hidden animate-in fade-in zoom-in-95 duration-200">
