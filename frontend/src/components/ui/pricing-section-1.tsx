...
export default function PricingSection2() {
  ...
  const calculatePrice = () => {
    if (!isUpdates && !isCorporate) return 98;
    if (isUpdates && !isCorporate) return 400;
    if (!isUpdates && isCorporate) return 159;
    if (isUpdates && isCorporate) return 650;
    return 98;
  };
    ...
    >
      <div className="bg-white py-16 px-4 ">
        <div
          ...
          style={{
            background:
              "radial-gradient(125% 125% at 50% 90%, #fff 40%, #f97316 100%)",
          }}
        />
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Zap className="h-5 w-5 text-orange-500 fill-orange-500 mr-2" />
            <span className="text-orange-600 font-medium">Time to connect</span>
          </TimelineContent>
            ...
            <div>
              ...
              <div className="space-y-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="w-6 h-6 bg-orange-500 shadow-md shadow-orange-500 rounded-full flex items-center justify-center mr-3">
